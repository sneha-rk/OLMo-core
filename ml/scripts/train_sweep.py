...
def main(
    ...
    **kwargs,
    ...
    overrides = {s.split('=')[0]: s.split('=')[1] for s in overrides.split(';')}  if overrides else None
    ...
    if relaunch_path or relaunch_name:
        ...
        SPECS = get_specs_for_user_and_model(USER_SPECS, HARDWARE_SPECS_DICT, model, partition, gpus, cpus, mem, overrides,gpu_type=gpu_type)
        ...
        grid = dict_update(grid, overrides) if overrides else grid
        # print(f"Relaunching sweep from {relaunch_path} with grid {grid} and specs {SPECS}")
        run_grid(
            grid,
            ...
            gpus=SPECS['NUM_GPUS'],
            gpu_type=(gpu_type if gpu_type else SPECS.get("GPU_TYPE", None)),
            cpus=SPECS["NUM_CPUS"],
        ...
        for model in MODELS:
            ...
            grid = {
                ...
                "subgrids": {
                    ...
                    # "e512x0.03125c32_nogen": {"moe_num_experts_list": ["512"], "moe_hidden_multipliers_list": ["0.03125"], "moe_router_top_ks_list": ["32"], "moe_generalist_hidden_multiplier": ["0"]},

                    # "e32x1c1_nogen": {"moe_num_experts_list": ["32"], "moe_hidden_multipliers_list": ["1"], "moe_router_top_ks_list": ["1"], "moe_generalist_hidden_multiplier": ["0"]},
                    ...
                    # "e2048x0.125c8_nogen": {"moe_num_experts_list": ["2048"], "moe_hidden_multipliers_list": ["0.125"], "moe_router_top_ks_list": ["8"], "moe_generalist_hidden_multiplier": ["0"]},
                    ...
                    # "e2048x0.25c4_nogen": {"moe_num_experts_list": ["2048"], "moe_hidden_multipliers_list": ["0.25"], "moe_router_top_ks_list": ["4"], "moe_generalist_hidden_multiplier": ["0"]},
                    ...
                    # "e2048x0.5c2_nogen": {"moe_num_experts_list": ["2048"], "moe_hidden_multipliers_list": ["0.5"], "moe_router_top_ks_list": ["2"], "moe_generalist_hidden_multiplier": ["0"]},
                    "e4096x0.25c4_nogen": {"moe_num_experts_list": ["4096"], "moe_hidden_multipliers_list": ["0.25"], "moe_router_top_ks_list": ["4"], "moe_generalist_hidden_multiplier": ["0"]},
                    
                    "e4096x0.5c2_nogen": {"moe_num_experts_list": ["4096"], "moe_hidden_multipliers_list": ["0.5"], "moe_router_top_ks_list": ["2"], "moe_generalist_hidden_multiplier": ["0"]},
                    "e8192x0.25c4_nogen": {"moe_num_experts_list": ["8192"], "moe_hidden_multipliers_list": ["0.25"], "moe_router_top_ks_list": ["4"], "moe_generalist_hidden_multiplier": ["0"]},

                    # "e8192x0.5c2_nogen": {"moe_num_experts_list": ["8192"], "moe_hidden_multipliers_list": ["0.5"], "moe_router_top_ks_list": ["2"], "moe_generalist_hidden_multiplier": ["0"]},
                    ...
                    # "e32,128x0.125,0.03125c4,16_nogen": {"moe_num_experts_list": ["32,128"], "moe_hidden_multipliers_list": ["0.125,0.03125"], "moe_router_top_ks_list": ["4,16"], "moe_generalist_hidden_multiplier": ["0"]},
                    # "e16,16,32x0.25,0.125,0.0625c2,2,4_nogen": {"moe_num_experts_list": ["16,16,32"], "moe_hidden_multipliers_list": ["0.25,0.125,0.0625"], "moe_router_top_ks_list": ["2,2,4"], "moe_generalist_hidden_multiplier": ["0"]},
                    # # "e64,64,128x0.25,0.125,0.0625c2,2,4_nogen": {"moe_num_experts_list": ["64,64,128"], "moe_hidden_multipliers_list": ["0.25,0.125,0.0625"], "moe_router_top_ks_list": ["2,2,4"], "moe_generalist_hidden_multiplier": ["0"]},
                    # "e128,128,256x0.125,0.0625,0.03125c4,4,8_nogen": {"moe_num_experts_list": ["128,128,256"], "moe_hidden_multipliers_list": ["0.125,0.0625,0.03125"], "moe_router_top_ks_list": ["4,4,8"], "moe_generalist_hidden_multiplier": ["0"]},
                    # "e16,64x0.25,0.125c2,4_nogen": {"moe_num_experts_list": ["16,64"], "moe_hidden_multipliers_list": ["0.25,0.125"], "moe_router_top_ks_list": ["2,4"], "moe_generalist_hidden_multiplier": ["0.5"]},
                    ...
                    # "e192,128x0.125,0.0625c4,8_nogen": {"moe_num_experts_list": ["192,128"], "moe_hidden_multipliers_list": ["0.125,0.0625"], "moe_router_top_ks_list": ["4,8"], "moe_generalist_hidden_multiplier": ["0"]},
                    # "e32,192x0.125,0.0625c4,8_nogen": {"moe_num_experts_list": ["32,192"], "moe_hidden_multipliers_list": ["0.125,0.0625"], "moe_router_top_ks_list": ["4,8"], "moe_generalist_hidden_multiplier": ["0"]},
                    ...
                    # "e15,30x0.25,0.125c1,2_0.5gen": {"moe_num_experts_list": ["15,30"], "moe_hidden_multipliers_list": ["0.25,0.12 five models
                    # ###
                    # 'e3x' + str(epochs) + 'c' + str(top_k) + '_gen': {'num_experts': [3], 'hidden_multiplier': [hidden_multiplier], 'router_top_k': [top_k], 'generalist_hidden_multiplier': [generalist_hidden_multiplier]},
                    # 'e6x' + str(epochs) + 'c' + str(top_k) + '_gen': {'num_experts': [6], 'hidden_multiplier': [hidden_multiplier], 'router_top_k': [top_k], 'generalist_hidden_multiplier': [generalist_hidden_multiplier]},
                    # 'e12x' + str(epochs) + 'c' + str(top_k) + '_gen': {'num_experts': [12], 'hidden_multiplier': [hidden_multiplier], 'router_top_k': [top_k], 'generalist_hidden_multiplier': [generalist_hidden_multiplier]},
...
if __name__ == '__main__':
    ...
    parser.add_argument('-or', '--override-args', type=str, help="comma-separated list of key=value pairs to override values in the grid. For example, 'per_gpu_batch_size=16'.")
